...
{% set productname = run_query('select CUSTOMER_ATTRIBUTE_NAME from "DATA_TO_INSIGHTS"."GOOGLE_DRIVE"."MAPPING_TEMPLATE" WHERE D_2_I_ATTRIBUTE_NAME= \'PRODUCT_NAME\' AND D_2_I_ENTITY_NAME = \'Product\'') %}
{% if execute %}
...
{% set segment = run_query('select CUSTOMER_ATTRIBUTE_NAME from "DATA_TO_INSIGHTS"."GOOGLE_DRIVE"."MAPPING_TEMPLATE" WHERE D_2_I_ATTRIBUTE_NAME= \'SEGMENT\' AND D_2_I_ENTITY_NAME = \'Product\'') %}
{% if execute %}
...
{% set subcategory = run_query('select CUSTOMER_ATTRIBUTE_NAME from "DATA_TO_INSIGHTS"."GOOGLE_DRIVE"."MAPPING_TEMPLATE" WHERE D_2_I_ATTRIBUTE_NAME= \'SUB_CATEGORY\' AND D_2_I_ENTITY_NAME = \'Product\'') %}
{% if execute %}
...
{% set category = run_query('select CUSTOMER_ATTRIBUTE_NAME from "DATA_TO_INSIGHTS"."GOOGLE_DRIVE"."MAPPING_TEMPLATE" WHERE D_2_I_ATTRIBUTE_NAME= \'CATEGORY\' AND D_2_I_ENTITY_NAME = \'Product\'') %}
{% if execute %}
...
{% set tablename = run_query('select CUSTOMER_ENTITY_TABLE_NAME from "DATA_TO_INSIGHTS"."GOOGLE_DRIVE"."MAPPING_TEMPLATE" WHERE D_2_I_ATTRIBUTE_NAME = \'PRODUCT_ID\' AND D_2_I_ENTITY_NAME = \'Product\'') %}
{% if execute %}
